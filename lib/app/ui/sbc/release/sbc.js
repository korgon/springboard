...
/***/ function(module, exports) {
	...
	function sitemanager($http, $q, $timeout) {
		...
		// install module
		function installModule(catalog_name, mod_name) {
			// TODO
		}
...
/***/ function(module, exports) {
	...
	function usermanager($http, $q, $window, $timeout) {
	  ...
	  function loadEditorSession(site_name, url) {
	    ...
	    var session_defaults = { site: site_name, showOptions: false, current_tab: 'settings', tab: { uigen: { vtab: {}, current: undefined }, settings: { vtab: {} } }, url: false };
	...
	function EditorCtrl($scope, $location, $window, $q, focus, usermanager, sitemanager, modalmanager) {
		...
		vm.installModule = function(catalog) {
			return modalmanager.open(
				'install',
				{
					library: vm.uis[catalog.type].modules,
...
/***/ function(module, exports) {
	...
	// Install Module Modal Controller
	/************************/
	angular
		.module('springboardApp')
		.controller('ModalInstallCtrl', ModalInstallCtrl);

	ModalInstallCtrl.$inject = ['$scope', 'modalmanager', 'focus'];

	function ModalInstallCtrl($scope, modalmanager, focus) {
		var params = modalmanager.params();
		var mm = {};
		$scope.mm = mm;

		// Setup defaults using the modal params.
		mm.library = params.library;
		mm.catalog = params.catalog;
