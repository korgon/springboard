...
* not compiling variables on module install?
* fix UNLINKING?
...
function springboard() {
	...
	self.installModule = (catalog_name, info) => {
		...
		if (site && site.name) {
			...
			if (library.catalogs[catalog_name]) {
				console.log('about to install...');
				return library.catalogs[catalog_name].modules[info.module].install(install_info).then(() => {
