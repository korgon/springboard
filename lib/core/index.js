...
! BUG: hash does not update in springboard location bar

* New sites
	- choose template
	- use json from template for new site?
	- compile SCSS on UI creation
