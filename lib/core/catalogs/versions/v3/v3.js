...
(function() {
	...
	var query = SearchSpring.Hooke.query ? (' search="' + SearchSpring.Hooke.query + '"') : '';
	var context = SearchSpring.Hooke.context ? (' ' + SearchSpring.Hooke.context) : '';

	document.write(unescape('%3Cscript src="//cdn.searchspring.net/search/v3/js/searchspring.catalog.js?' + SearchSpring.Hooke.siteid + '"' + query + context + '%3E%3C/script%3E'));
