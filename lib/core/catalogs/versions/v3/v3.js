...
(function() {
	...
	document.write(unescape('%3Cscript src="//cdn.searchspring.net/search/v3/js/searchspring.catalog.js?' + SearchSpring.Hooke.siteid + '" search="' + SearchSpring.Hooke.query + '"%3E%3C/script%3E'));
