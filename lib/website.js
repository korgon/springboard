...
website.prototype.checkout = function() {
	...
	return new Promise(function(resolve, reject) {
		//checkout git branch
		try {
			git.exec({args: 'checkout site/' + self.name, cwd: mockup_dir}, function (err) {
				if (err) {
					return reject(err);
				}
				return resolve(self);
...
website.prototype.push = function() {
	self = this;
	// promisified
	return new Promise(function(resolve, reject) {
		try {
...
// 	return new Promise(function(resolve, reject) {
// 		try {
// 			git.exec({args: 'add sites/' + self.name, cwd: mockup_dir}, function (err) {
// 				if (err) {
// 					return reject(err);
// 				}
// 				try {
// 					git.exec({args: 'commit -m "' + message + '"', cwd: mockup_dir}, function (err) {
// 						if (err) {
// 							return reject(err);
// 						}
// 						return resolve(true);
