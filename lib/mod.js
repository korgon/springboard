...
install steps
* create modules folder inside of build folder (if it does not exist) copy config file into modules folder
* copy js and/or scss files into respective site folders (build, scss)
* append scss include to main scss file
