...
Watch for image changes and inject changes (beholder)
*/
...
function watchers() {
	...
	let eyes = {
		...
		eye_of_the_beholder: null,	// used for watching images
	...
	function startWatch() {
		...
		eyes.eye_of_the_beholder = watchImg();
	...
	function watchImg() {
		// which files to watch...
		let watch_list = [
			site.directory + '/img/*.png',
			site.directory + '/img/*.jpg',
			site.directory + '/img/*.jpeg',
			site.directory + '/img/*.gif',
			site.directory + '/img/*.svg'
		];
