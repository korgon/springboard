...
- site/vthree/slide/update		// update module
- site/vthree/slide/install		// install theme

- when git commit, check git status, if nothing to commit say so
- when git push, check git status, if stuff to commit, then commit and push if nothing to commit or push say so
