...
var checkGeneratedDir = (generated_dir) => {
...
var compileJs = (state) => {
	var generated_dir = state.directory + '/' + variables.COMPILE_DIR;
	var js_dir = state.directory + '/' + variables.JS_DIR;
	var js_concat = generated_dir + '/' + variables.COMPILED_JS;

	return checkGeneratedDir(generated_dir).then(fspro.concatFiles(js_dir, js_concat));
}

var compileTemplates = (state) => {
	var generated_dir = state.directory + '/' + variables.COMPILE_DIR;
	var templates_dir = state.directory + '/' + variables.TEMPLATES_DIR;
	var templates_concat = generated_dir + '/' + variables.COMPILED_TEMPLATES;
