...
// module factory
var mod = (name, directory, catalog_directory, data) => {
	let state = {
		name,
		directory,
		catalog_directory,
...
var loadTheme = (name, theme_dir, state) => {
...
var link = (catalog_directory, module_directory, module_name, theme_name) => {
	// link locations
	var js_link = catalog_directory + '/' + variables.JS_DIR + '/' + module_name;
	var sass_link = catalog_directory + '/' + variables.SASS_DIR + '/' + module_name;
	var templates_link = catalog_directory + '/' + variables.TEMPLATES_DIR + '/' + module_name;

	// actual files
	var real_js_link = module_directory + '/' + theme_name + '/' + variables.JS_DIR;
	var real_sass_link = module_directory + '/' + theme_name + '/' + variables.SASS_DIR;
	var real_templates_link = module_directory + '/' + theme_name + '/' + variables.TEMPLATES_DIR;
