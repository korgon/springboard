...
library.load('/home/korgon/Work/springboard/springboard-library').then(lib => {
	lib.catalogs.v3.install({ name: 'v3', directory: dir }).then(() => {
		lib.catalogs.v3.modules.slideout.install({ name: 'slideout', directory: testsite.catalogs.v3.directory, theme: 'default' });
	});
