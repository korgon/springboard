...
lib.load('/home/korgon/Work/springboard/springboard-library').then(l => {
	...
	//return library.catalogs.v3.modules.slideout.install({ name: 'slidie', directory: testsite.catalogs.v3.directory, theme: 'blocky' });
	testsite.catalogs.v3.modules.slideout.setTheme('default');
}).catch(err => {
	console.log(err);
	console.log('errr!!!');
	console.log(library);
