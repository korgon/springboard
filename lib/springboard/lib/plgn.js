...
/* ideas
Should really be called modules
modules can have themes
...
object prototype example
{
  ...
  "variables": {
    "respondAt": {
      ...
      "default": 768,
      "type": "integer",
      "description": "display slideout at this width in pixels"
    }
  },
  "styles": {},
}
...
var export_options = ['type', 'version', 'enabled', 'description', 'variables', 'styles'];
