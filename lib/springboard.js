...
function springboard() {
	...
	*/
	...
	function watchJs() {
		...
		var buildlist = [site.directory + '/src/_init.js', site.directory + '/src/_integration.js', site.directory + '/src/*.js'];
	...
	function renderInitScripts(details) {
		// promisified
			return new Promise(function(resolve, reject) {
				...
				var site_script_dir = sites_dir + details.name + '/src/';
