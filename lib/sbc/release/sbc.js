...
/***/ function(module, exports) {
	...
	function EditorCtrl($location, $window, focus, sitemanager, modalmanager) {
	  ...
	  sitemanager.getSite().then(function(site) {
	    ...
	    var session_defaults = { site: site.name, showOptions: false, current_tab: 'uigen', tabs: { uigen: {}, settings: {} }, url: false };

	    vm.session = angular.fromJson($window.sessionStorage.getItem('editorStorage')) || session_defaults;
	    ...
	    $window.addEventListener('beforeunload', function() {
	      ...
	      $window.sessionStorage.setItem('editorStorage', angular.toJson(vm.session));
	    });
	  }, function(err) {
